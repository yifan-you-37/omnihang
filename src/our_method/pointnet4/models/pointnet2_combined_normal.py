...
def get_model(point_cloud, l0_points, is_training, bn_decay=None):
    ...
    nor = tf_util.conv1d(l0_points, 32, 1, padding='VALID', bn=False, is_training=is_training, scope='fc2',bn_decay=bn_decay)
    nor = tf_util.conv1d(nor, 3, 1, padding='VALID', bn=False, is_training=is_training, scope='fc2_1', activation_fn=None)
