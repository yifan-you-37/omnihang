...
if __name__ == '__main__':
	...
	for hook_name in all_hook_name:
		# for i in range(5):
			...
			command = 'python prepare_cp_dataset_by_hook.py --home_dir_data {} --hook_name {}'.format(args.home_dir_data, hook_name)
			all_commands.append(command)

	
	output_command_dir = 'prepare_cp_dataset_commands.txt'
