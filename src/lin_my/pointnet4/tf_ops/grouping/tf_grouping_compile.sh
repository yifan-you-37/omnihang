...
g++ -std=c++11 tf_grouping.cpp tf_grouping_g.cu.o -o tf_grouping_so.so -shared -fPIC -I$TF_INC -I /usr/local/cuda-9.0/include -I$TF_INC/external/nsync/public -L$TF_LIB -ltensorflow_framework -lcudart -L /usr/local/cuda-9.0/lib64/ -O2 -D_GLIBCXX_USE_CXX11_ABI=0